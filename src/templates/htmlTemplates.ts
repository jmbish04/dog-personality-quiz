// This file contains HTML templates as constants
// These are the extracted templates from the original pages.ts

export const HOME_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
...
export const QUIZ_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
export const RESULTS_TEMPLATE = `<!DOCTYPE html>
<html lang="en">
<head>
    <meta charset="UTF-8">
    <meta name="viewport" content="width=device-width, initial-scale=1.0">
...
<body class="bg-gradient-to-br from-blue-100 to-purple-100 min-h-screen">
    ...
    <script>
        ...
        function shareImage(trait) {
            const generatedImages = {{GENERATED_IMAGES_JSON}};
